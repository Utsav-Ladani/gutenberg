 ...
 */
const DependencyExtractionRspackPlugin = require( '@wordpress/dependency-extraction-rspack-plugin' );
...
class BlocksManifestPlugin {
	 ...
	 * Apply the plugin.
	 *
	 * @param {rspack.Compiler} compiler The compiler instance.
	 */
	apply( compiler ) {
...
const scriptConfig = {
	...
	plugins: [
		...
		// rspack.CssExtractRspackPlugin to extract the CSS thats gets imported into JavaScript.
		...
		// React Fast Refresh.
		hasReactFastRefresh && new ReactRefreshRspackPlugin(),
		// WP_NO_EXTERNALS global variable controls whether scripts' assets get
		// generated, and the default externals set.
		! process.env.WP_NO_EXTERNALS && new DependencyExtractionRspackPlugin(),
	].filter( Boolean ),
};
	...
	const moduleConfig = {
		...
		plugins: [
			...
			! process.env.WP_NO_EXTERNALS &&
				new DependencyExtractionRspackPlugin(),
